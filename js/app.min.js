(() => {
  ...
  let l = (e, t = !1, s = 500, i = 0) => {
    ...
    if (r) {
      ...
      n(`[gotoBlock]: Юхуу...їдемо до ${e}`);
    } else n(`[gotoBlock]: Йой... Такого блоку немає на сторінці: ${e}`);
  };
  function d(e) {
    return (
      null !== e &&
  ...
  var B = {
    ...
    updateSlides: function () {
      ...
      const s = e.params,
        ...
        c = b(r, `.${e.params.slideClass}, swiper-slide`),
      ...
      if (
        ...
        L && e.grid.updateWrapperSize(P, p),
        !s.centeredSlides)
      ) {
        const t = [];
      ...
      if (
        ...
        y(i, "--swiper-centered-offset-before", -p[0] + "px"),
          y(
            i,
    ...
    updateSlidesClasses: function () {
      const e = this,
        ...
        o = (e) => b(i, `.${s.slideClass}${e}, swiper-slide${e}`)[0];
      let l, d, c;
      if (a)
        if (s.loop) {
      ...
      l &&
        ...
        t.forEach((e) => {
          N(e, e === l, s.slideActiveClass),
            N(e, e === c, s.slideNextClass),
            N(e, e === d, s.slidePrevClass);
        }),
        e.emitSlidesClasses();
    },
  ...
  var H = {
    ...
    loopFix: function (e) {
      ...
      const C = w ? Math.ceil(d.length / h.grid.rows) : d.length,
        P = (w ? d[a].column : a) + (m && void 0 === r ? -f / 2 + 0.5 : 0);
      if (P < v) {
        M = Math.max(v - P, g);
  ...
  function X(e) {
    ...
    if (!i.isMoved) {
      if (
        (S && y && s.loopFix({ direction: s.swipeDirection }),
          ...
          i.currentTranslate > s.minTranslate() &&
            ...
            r.resistance &&
              (i.currentTranslate =
                s.minTranslate() -
                1 +
                (-s.minTranslate() + i.startTranslate + f) ** b)))
        : f < 0 &&
          (S &&
            y &&
            i.allowThresholdMove &&
          ...
          i.currentTranslate < s.maxTranslate() &&
            ...
            r.resistance &&
              (i.currentTranslate =
                s.maxTranslate() +
                1 -
                (s.maxTranslate() - i.startTranslate - f) ** b))),
  ...
  function U(e) {
    ...
    for (
      ...
      void 0 !== l[e + t]
        ? (h || (p >= l[e] && p < l[e + t])) && ((m = e), (v = l[e + t] - l[e]))
        : (h || p >= l[e]) &&
          ((m = e), (v = l[l.length - 1] - l[l.length - 2]));
    }
    let w = null,
      S = null;
    a.rewind &&
      (t.isBeginning
        ...
        : t.isEnd && (w = 0));
    const y = (p - l[m]) / v,
      T = m < a.slidesPerGroupSkip - 1 ? 1 : a.slidesPerGroup;
    if (u > a.longSwipesMs) {
      if (!a.longSwipes) return void t.slideTo(t.activeIndex);
      "next" === t.swipeDirection &&
        (y >= a.longSwipesRatio
          ? t.slideTo(a.rewind && t.isEnd ? w : m + T)
          : t.slideTo(m)),
        "prev" === t.swipeDirection &&
          (y > 1 - a.longSwipesRatio
            ? t.slideTo(m + T)
            : null !== S && y < 0 && Math.abs(y) > a.longSwipesRatio
            ? t.slideTo(S)
            : t.slideTo(m));
    } else {
      ...
      (r.target === t.navigation.nextEl || r.target === t.navigation.prevEl)
        ? r.target === t.navigation.nextEl
          ? t.slideTo(m + T)
          : t.slideTo(m)
        : ("next" === t.swipeDirection && t.slideTo(null !== w ? w : m + T),
          "prev" === t.swipeDirection && t.slideTo(null !== S ? S : m));
    }
  }
  function K() {
    const e = this,
      ...
      breakpoints: {
        setBreakpoint: function () {
          ...
          const h = o.direction && o.direction !== i.direction,
            ...
            f = i.loop;
          h && s && e.changeDirection(), S(e.params, o);
  ...
  class oe {
    ...
    getSlideIndex(e) {
      const { slidesEl: t, params: s } = this,
        i = L(b(t, `.${s.slideClass}, swiper-slide`)[0]);
      return L(e) - i;
    }
  ...
  function de(e) {
    let t,
      s,
      { swiper: i, extendParams: r, on: a, emit: n, params: o } = e;
    ...
    const T = () => {
        ...
        const e = i.autoplay.paused ? l : S + w - new Date().getTime();
      ...
      M = (e, s) => {
        ...
        if (((i.autoplay.paused = !0), s))
          return m && (l = i.params.autoplay.delay), (m = !1), void r();
        const a = l || i.params.autoplay.delay;
        (l = a - (new Date().getTime() - S)),
    ...
    a("init", () => {
      ...
      a("_freeModeNoMomentumRelease", () => {
        i.params.autoplay.disableOnInteraction ? x() : M(!0, !0);
      }),
      a("beforeTransitionStart", (e, t, s) => {
        !i.destroyed &&
          i.autoplay.running &&
          (s || !i.params.autoplay.disableOnInteraction ? M(!0, !0) : x());
      }),
      a("sliderFirstMove", () => {
        !i.destroyed &&
          i.autoplay.running &&
      ...
      Object.assign(i.autoplay, { start: E, stop: x, pause: M, resume: L });
  }
    ...
    window.addEventListener("load", function (e) {
      document.querySelector(".swiper") &&
        new oe(".swiper", {
          ...
          breakpoints: {
            320: { slidesPerView: 3, spaceBetween: 5, autoHeight: !0 },
            480: { slidesPerView: 3.6, spaceBetween: 10 },
  ...
  async function ue() {
    try {
      const e = "0xf6e932ca12afa26665dc4dde7e27be02a7c02e40";
